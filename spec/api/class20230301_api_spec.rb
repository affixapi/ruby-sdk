...
# Unit tests for OpenapiClient::Class20230301Api
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Class20230301Api' do
  before do
  ...
  describe 'test an instance of Class20230301Api' do
    it 'should create an instance of Class20230301Api' do
      expect(@api_instance).to be_instance_of(OpenapiClient::Class20230301Api)
    end
  end

  # unit tests for official_companies20230301
  # Company
  # Retrieve company information 
  # @param [Hash] opts the optional parameters
  # @return [Array<CompanyResponse>]
  describe 'official_companies20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for official_create_employee20230301
  # Create Employee
  # Creates a new Employee 
  # @param create_employee_request 
  # @param [Hash] opts the optional parameters
  # @return [EmployeeResponse]
  describe 'official_create_employee20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for official_employees20230301
  # Employees
  # List the individuals (employees, contractors, accountants, and others) listed in the HRIS/Payroll software 
  # @param [Hash] opts the optional parameters
  # @return [Array<EmployeeResponse>]
  describe 'official_employees20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for official_groups20230301
  # Groups
  ...
  describe 'official_groups20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for official_time_off_balances20230301
  # Time off balances
  # Retrieve all time off balances. 
  # @param [Hash] opts the optional parameters
  # @return [Array<TimeOffBalanceResponse>]
  describe 'official_time_off_balances20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for official_time_off_entries20230301
  # Time off entries
  # Retrieve time off / absence entries 
  # @param [Hash] opts the optional parameters
  # @return [Array<TimeOffEntryResponse>]
  describe 'official_time_off_entries20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for official_timesheets20230301
  # Timesheets
  # Retrieve Timesheets 
  # @param [Hash] opts the optional parameters
  # @return [Array<TimesheetResponse>]
  describe 'official_timesheets20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for official_work_locations20230301
  # Work locations
  # The Location object is used to represent an address that can be associated with an employee 
  # @param [Hash] opts the optional parameters
  # @return [Array<LocationResponse>]
  describe 'official_work_locations20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for officialdentity20230301
  # Identity
  # List information of the user for the respective account 
  # @param [Hash] opts the optional parameters
  # @return [IdentityResponse]
  describe 'officialdentity20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for xhr_companies20230301
  # Company
  # Retrieve company information 
  # @param [Hash] opts the optional parameters
  # @return [Array<CompanyResponse>]
  describe 'xhr_companies20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for xhr_groups20230301
  # Groups
  # The Group object is used to represent any subset of employees, such as PayGroup, Team, or Department. Employees can be in multiple Groups. 
  # @param [Hash] opts the optional parameters
  # @return [Array<GroupResponse>]
  describe 'xhr_groups20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for xhr_identity20230301
  # Identity
  # List information of the user for the respective account 
  # @param [Hash] opts the optional parameters
  # @return [IdentityResponse]
  describe 'xhr_identity20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'xhr_payruns20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'xhr_payslips20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for xhr_time_off_balances20230301
  # Time off balances
  # Retrieve all time off balances. 
  # @param [Hash] opts the optional parameters
  # @return [Array<TimeOffBalanceResponse>]
  describe 'xhr_time_off_balances20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for xhr_work_locations20230301
  # Work locations
  # The Location object is used to represent an address that can be associated with an employee 
  # @param [Hash] opts the optional parameters
  # @return [Array<LocationResponse>]
  describe 'xhr_work_locations20230301 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
