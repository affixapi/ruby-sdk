...
# Unit tests for OpenapiClient::XHRApi
...
describe 'XHRApi' do
  ...
  describe 'test an instance of XHRApi' do
    it 'should create an instance of XHRApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::XHRApi)
    end
  end
