...
# Unit tests for OpenapiClient::OfficialApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OfficialApi' do
  before do
  ...
  describe 'test an instance of OfficialApi' do
    it 'should create an instance of OfficialApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::OfficialApi)
    end
  end
