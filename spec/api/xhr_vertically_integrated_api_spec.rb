...
# Unit tests for OpenapiClient::XHRVerticallyIntegratedApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'XHRVerticallyIntegratedApi' do
  before do
  ...
  describe 'test an instance of XHRVerticallyIntegratedApi' do
    it 'should create an instance of XHRVerticallyIntegratedApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::XHRVerticallyIntegratedApi)
    end
  end
