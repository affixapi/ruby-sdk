...
# Unit tests for OpenapiClient::GroupNoNullEnumRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GroupNoNullEnumRequest do
  let(:instance) { OpenapiClient::GroupNoNullEnumRequest.new }

  describe 'test an instance of GroupNoNullEnumRequest' do
    it 'should create an instance of GroupNoNullEnumRequest' do
      expect(instance).to be_instance_of(OpenapiClient::GroupNoNullEnumRequest)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["department", "team", "cost_centre", "pay_group"])
