...
# Unit tests for OpenapiClient::CreateEmployeeRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateEmployeeRequest do
  let(:instance) { OpenapiClient::CreateEmployeeRequest.new }

  describe 'test an instance of CreateEmployeeRequest' do
    it 'should create an instance of CreateEmployeeRequest' do
      expect(instance).to be_instance_of(OpenapiClient::CreateEmployeeRequest)
    end
  end
  ...
  describe 'test attribute "gender"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["male", "female", "not_specified"])
  ...
  describe 'test attribute "ethnicity"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["asian", "black", "hispanic", "mixed", "not_specified", "other", "white"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "employment_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["full_time", "part_time", "contractor", "other"])
      # validator.allowable_values.each do |value|
