...
# Unit tests for OpenapiClient::TimesheetResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TimesheetResponse do
  let(:instance) { OpenapiClient::TimesheetResponse.new }

  describe 'test an instance of TimesheetResponse' do
    it 'should create an instance of TimesheetResponse' do
      expect(instance).to be_instance_of(OpenapiClient::TimesheetResponse)
    end
  end
