...
# Unit tests for OpenapiClient::TimeOffBalanceResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TimeOffBalanceResponse do
  let(:instance) { OpenapiClient::TimeOffBalanceResponse.new }

  describe 'test an instance of TimeOffBalanceResponse' do
    it 'should create an instance of TimeOffBalanceResponse' do
      expect(instance).to be_instance_of(OpenapiClient::TimeOffBalanceResponse)
    end
  end
  ...
  describe 'test attribute "policy_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["vacation", "sick", "personal", "jury_duty", "volunteer", "bereavement"])
