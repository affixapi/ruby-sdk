...
# Unit tests for OpenapiClient::ClientRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ClientRequest do
  let(:instance) { OpenapiClient::ClientRequest.new }

  describe 'test an instance of ClientRequest' do
    it 'should create an instance of ClientRequest' do
      expect(instance).to be_instance_of(OpenapiClient::ClientRequest)
    end
  end
  ...
  describe 'test attribute "webhook_uri"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
