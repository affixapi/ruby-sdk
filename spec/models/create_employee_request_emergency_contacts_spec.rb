...
# Unit tests for OpenapiClient::CreateEmployeeRequestEmergencyContacts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateEmployeeRequestEmergencyContacts do
  let(:instance) { OpenapiClient::CreateEmployeeRequestEmergencyContacts.new }

  describe 'test an instance of CreateEmployeeRequestEmergencyContacts' do
    it 'should create an instance of CreateEmployeeRequestEmergencyContacts' do
      expect(instance).to be_instance_of(OpenapiClient::CreateEmployeeRequestEmergencyContacts)
    end
  end
