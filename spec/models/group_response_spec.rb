...
# Unit tests for OpenapiClient::GroupResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GroupResponse do
  let(:instance) { OpenapiClient::GroupResponse.new }

  describe 'test an instance of GroupResponse' do
    it 'should create an instance of GroupResponse' do
      expect(instance).to be_instance_of(OpenapiClient::GroupResponse)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["null", "department", "team", "cost_centre", "pay_group"])
