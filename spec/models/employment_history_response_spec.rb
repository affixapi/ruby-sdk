...
# Unit tests for OpenapiClient::EmploymentHistoryResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EmploymentHistoryResponse do
  let(:instance) { OpenapiClient::EmploymentHistoryResponse.new }

  describe 'test an instance of EmploymentHistoryResponse' do
    it 'should create an instance of EmploymentHistoryResponse' do
      expect(instance).to be_instance_of(OpenapiClient::EmploymentHistoryResponse)
    end
  end
