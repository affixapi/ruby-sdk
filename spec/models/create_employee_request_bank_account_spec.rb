...
# Unit tests for OpenapiClient::CreateEmployeeRequestBankAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateEmployeeRequestBankAccount do
  let(:instance) { OpenapiClient::CreateEmployeeRequestBankAccount.new }

  describe 'test an instance of CreateEmployeeRequestBankAccount' do
    it 'should create an instance of CreateEmployeeRequestBankAccount' do
      expect(instance).to be_instance_of(OpenapiClient::CreateEmployeeRequestBankAccount)
    end
  end
