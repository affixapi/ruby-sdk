...
# Unit tests for OpenapiClient::EmployeeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EmployeeResponse do
  let(:instance) { OpenapiClient::EmployeeResponse.new }

  describe 'test an instance of EmployeeResponse' do
    it 'should create an instance of EmployeeResponse' do
      expect(instance).to be_instance_of(OpenapiClient::EmployeeResponse)
    end
  end
  ...
  describe 'test attribute "gender"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["male", "female", "not_specified", "null"])
  ...
  describe 'test attribute "ethnicity"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["null", "asian", "black", "hispanic", "mixed", "not_specified", "other", "white"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "employment_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["null", "active", "inactive", "pending", "leave"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "employment_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["null", "full_time", "part_time", "contractor", "other"])
      # validator.allowable_values.each do |value|
