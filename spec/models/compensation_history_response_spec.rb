...
# Unit tests for OpenapiClient::CompensationHistoryResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CompensationHistoryResponse do
  let(:instance) { OpenapiClient::CompensationHistoryResponse.new }

  describe 'test an instance of CompensationHistoryResponse' do
    it 'should create an instance of CompensationHistoryResponse' do
      expect(instance).to be_instance_of(OpenapiClient::CompensationHistoryResponse)
    end
  end
  ...
  describe 'test attribute "employment_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["full_time", "part_time", "contractor", "other", "null"])
      # validator.allowable_values.each do |value|
