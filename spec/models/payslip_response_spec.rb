...
# Unit tests for OpenapiClient::PayslipResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PayslipResponse do
  let(:instance) { OpenapiClient::PayslipResponse.new }

  describe 'test an instance of PayslipResponse' do
    it 'should create an instance of PayslipResponse' do
      expect(instance).to be_instance_of(OpenapiClient::PayslipResponse)
    end
  end
