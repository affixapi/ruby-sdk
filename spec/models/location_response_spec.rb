...
# Unit tests for OpenapiClient::LocationResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LocationResponse do
  let(:instance) { OpenapiClient::LocationResponse.new }

  describe 'test an instance of LocationResponse' do
    it 'should create an instance of LocationResponse' do
      expect(instance).to be_instance_of(OpenapiClient::LocationResponse)
    end
  end
