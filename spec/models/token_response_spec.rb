...
# Unit tests for OpenapiClient::TokenResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TokenResponse do
  let(:instance) { OpenapiClient::TokenResponse.new }

  describe 'test an instance of TokenResponse' do
    it 'should create an instance of TokenResponse' do
      expect(instance).to be_instance_of(OpenapiClient::TokenResponse)
    end
  end
