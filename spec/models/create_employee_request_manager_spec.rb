...
# Unit tests for OpenapiClient::CreateEmployeeRequestManager
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateEmployeeRequestManager do
  let(:instance) { OpenapiClient::CreateEmployeeRequestManager.new }

  describe 'test an instance of CreateEmployeeRequestManager' do
    it 'should create an instance of CreateEmployeeRequestManager' do
      expect(instance).to be_instance_of(OpenapiClient::CreateEmployeeRequestManager)
    end
  end
