...
# Unit tests for OpenapiClient::ClientResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ClientResponse do
  let(:instance) { OpenapiClient::ClientResponse.new }

  describe 'test an instance of ClientResponse' do
    it 'should create an instance of ClientResponse' do
      expect(instance).to be_instance_of(OpenapiClient::ClientResponse)
    end
  end
