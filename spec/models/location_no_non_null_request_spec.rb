...
# Unit tests for OpenapiClient::LocationNoNonNullRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LocationNoNonNullRequest do
  let(:instance) { OpenapiClient::LocationNoNonNullRequest.new }

  describe 'test an instance of LocationNoNonNullRequest' do
    it 'should create an instance of LocationNoNonNullRequest' do
      expect(instance).to be_instance_of(OpenapiClient::LocationNoNonNullRequest)
    end
  end
