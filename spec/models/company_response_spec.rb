...
# Unit tests for OpenapiClient::CompanyResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CompanyResponse do
  let(:instance) { OpenapiClient::CompanyResponse.new }

  describe 'test an instance of CompanyResponse' do
    it 'should create an instance of CompanyResponse' do
      expect(instance).to be_instance_of(OpenapiClient::CompanyResponse)
    end
  end
