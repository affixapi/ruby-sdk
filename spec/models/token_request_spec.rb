...
# Unit tests for OpenapiClient::TokenRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TokenRequest do
  let(:instance) { OpenapiClient::TokenRequest.new }

  describe 'test an instance of TokenRequest' do
    it 'should create an instance of TokenRequest' do
      expect(instance).to be_instance_of(OpenapiClient::TokenRequest)
    end
  end
  ...
  describe 'test attribute "grant_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["authorization_code"])
