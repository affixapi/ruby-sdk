...
# Unit tests for OpenapiClient::EmploymentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EmploymentResponse do
  let(:instance) { OpenapiClient::EmploymentResponse.new }

  describe 'test an instance of EmploymentResponse' do
    it 'should create an instance of EmploymentResponse' do
      expect(instance).to be_instance_of(OpenapiClient::EmploymentResponse)
    end
  end
