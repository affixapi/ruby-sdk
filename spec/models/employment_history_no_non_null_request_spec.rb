...
# Unit tests for OpenapiClient::EmploymentHistoryNoNonNullRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EmploymentHistoryNoNonNullRequest do
  let(:instance) { OpenapiClient::EmploymentHistoryNoNonNullRequest.new }

  describe 'test an instance of EmploymentHistoryNoNonNullRequest' do
    it 'should create an instance of EmploymentHistoryNoNonNullRequest' do
      expect(instance).to be_instance_of(OpenapiClient::EmploymentHistoryNoNonNullRequest)
    end
  end
  ...
  describe 'test attribute "group_remote_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
