...
# Unit tests for OpenapiClient::TimeOffEntryResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TimeOffEntryResponse do
  let(:instance) { OpenapiClient::TimeOffEntryResponse.new }

  describe 'test an instance of TimeOffEntryResponse' do
    it 'should create an instance of TimeOffEntryResponse' do
      expect(instance).to be_instance_of(OpenapiClient::TimeOffEntryResponse)
    end
  end
  ...
  describe 'test attribute "unit"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["null", "hours", "days", "months"])
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["null", "approved", "pending", "rejected"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "remote_modified_at"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
