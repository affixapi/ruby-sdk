...
# Unit tests for OpenapiClient::PayrunResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PayrunResponse do
  let(:instance) { OpenapiClient::PayrunResponse.new }

  describe 'test an instance of PayrunResponse' do
    it 'should create an instance of PayrunResponse' do
      expect(instance).to be_instance_of(OpenapiClient::PayrunResponse)
    end
  end
