...
# Unit tests for OpenapiClient::IntrospectResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::IntrospectResponse do
  let(:instance) { OpenapiClient::IntrospectResponse.new }

  describe 'test an instance of IntrospectResponse' do
    it 'should create an instance of IntrospectResponse' do
      expect(instance).to be_instance_of(OpenapiClient::IntrospectResponse)
    end
  end
