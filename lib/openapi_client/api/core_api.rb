...
module OpenapiClient
  class CoreApi
    ...
    # @return [Array<Object>]
    def providers(opts = {})
      data, _status_code, _headers = providers_with_http_info(opts)
      data
    end
    ...
    def providers_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CoreApi.providers ...'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CoreApi#providers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
