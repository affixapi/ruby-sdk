...
module OpenapiClient
  class ProviderResponse
    ...
    BAMBOOHR = "bamboohr".freeze
    BREATHE = "breathe".freeze
    CEZANNE = "cezanne".freeze
    CHARLIEHR = "charliehr".freeze
    DEEL = "deel".freeze
    DEPUTY = "deputy".freeze
    HAILYHR = "hailyhr".freeze
    HIBOB = "hibob".freeze
    HUMAANS = "humaans".freeze
    IRIS_CASCADE = "iris cascade".freeze
    MOOREPAY = "moorepay".freeze
    NMBRS = "nmbrs".freeze
    PAROLLA_IE = "parolla.ie".freeze
    ...
    XERO_UK = "xero uk".freeze
    BRAIN_PAYROLL = "brain payroll".freeze
    BRIGHTPAY_CONNECT = "brightpay connect".freeze
    ...
    def build_from_hash(value)
      constantValues = ProviderResponse.constants.select { |c| ProviderResponse::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #ProviderResponse" if constantValues.empty?
      value
    end
  end
end
