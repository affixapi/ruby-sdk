...
module OpenapiClient
  class ProviderRequest
    ...
    def build_from_hash(value)
      constantValues = ProviderRequest.constants.select { |c| ProviderRequest::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #ProviderRequest" if constantValues.empty?
      value
    end
  end
end
