...
module OpenapiClient
  class TimeOffBalanceResponse
    ...
    def valid?
      ...
      policy_type_validator = EnumAttributeValidator.new('String', ["vacation", "sick", "personal", "jury_duty", "volunteer", "bereavement"])
    ...
    def policy_type=(policy_type)
      validator = EnumAttributeValidator.new('String', ["vacation", "sick", "personal", "jury_duty", "volunteer", "bereavement"])
