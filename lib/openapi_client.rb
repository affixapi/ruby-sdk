...
# Models
require 'openapi_client/models/address_no_non_null_request'
require 'openapi_client/models/address_response'
require 'openapi_client/models/client_request'
require 'openapi_client/models/client_response'
require 'openapi_client/models/company_response'
require 'openapi_client/models/compensation_history_no_non_null_request'
require 'openapi_client/models/compensation_history_response'
...
require 'openapi_client/models/employment_history_no_non_null_request'
require 'openapi_client/models/employment_history_response'
...
require 'openapi_client/models/group_response'
require 'openapi_client/models/id_and_message_response'
require 'openapi_client/models/identity_response'
require 'openapi_client/models/inline_response400'
require 'openapi_client/models/inline_response401'
require 'openapi_client/models/inline_response409'
require 'openapi_client/models/introspect_response'
require 'openapi_client/models/location_no_non_null_request'
...
require 'openapi_client/models/payslip_response_reimbursements'
...
require 'openapi_client/models/scopes_response'
require 'openapi_client/models/time_off_balance_response'
require 'openapi_client/models/time_off_entry_response'
require 'openapi_client/models/timesheet_response'
require 'openapi_client/models/token_request'
require 'openapi_client/models/token_response'

# APIs
require 'openapi_client/api/class20230301_api'
require 'openapi_client/api/core_api'
require 'openapi_client/api/management_api'
require 'openapi_client/api/xhr_vertically_integrated_api'
